...
function calculateEstimates() {
    ...
    document.getElementById("weekly").innerHTML = "Weekly amount: " + new Intl.NumberFormat('en-US', { style: 'currency', currency: 'PHP' }).format(weekly);
    document.getElementById("monthly").innerHTML = "Monthly amount: " + new Intl.NumberFormat('en-US', { style: 'currency', currency: 'PHP' }).format(monthly);
...
function calculateCategories(percentInput) {
    ...
    if (percentInput.value > 0 && percentInput.value <= 100) {
        ...
        categoryLabel.innerHTML = "Total amount: " + new Intl.NumberFormat('en-US', { style: 'currency', currency: 'PHP' }).format(categoryBudget * (percentInput.value / 100)) + "<br>Weekly amount: " + new Intl.NumberFormat('en-US', { style: 'currency', currency: 'PHP' }).format(categoryWeekly * (percentInput.value / 100)) + "<br>Monthly amount: " + new Intl.NumberFormat('en-US', { style: 'currency', currency: 'PHP' }).format(categoryMonthly * (percentInput.value / 100));
